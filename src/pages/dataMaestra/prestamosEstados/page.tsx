        ...
        <>
            <Col span={18} offset={3}>
                <Flex align="center" justify="space-between">
                    <Title level={3} style={{ fontWeight: 'bolder', marginBottom: 0, color: token.colorPrimary }}>Estados de Prestamos</Title>
                    <ButtonPrimary size="large" onClick={nuevo}>Nuevo Estado de Prestamo</ButtonPrimary>
                </Flex>
