...
export default function MenuApp() {
    ...
    const items: MenuItem[] = [
        ...
        },
        {
            ...
            children: [
                { key: `${Urls.Configuraciones.Base}/${Urls.Configuraciones.Ciudades}`, label: 'Ciudades', icon: <IconConfig style={{ fontSize: 18 }} /> },
                { key: `${Urls.Configuraciones.Base}/${Urls.Configuraciones.DocumentosTipos}`, label: 'Tipos de Documentos', icon: <IconConfig style={{ fontSize: 18 }} /> },
                { key: `${Urls.Configuraciones.Base}/${Urls.Configuraciones.FormasPago}`, label: 'Formas de Pago', icon: <IconConfig style={{ fontSize: 18 }} /> },
                { key: `${Urls.Configuraciones.Base}/${Urls.Configuraciones.MetodosPago}`, label: 'Métodos de Pago', icon: <IconConfig style={{ fontSize: 18 }} /> },
                { key: `${Urls.Configuraciones.Base}/${Urls.Configuraciones.Monedas}`, label: 'Tipo de Monedas', icon: <IconConfig style={{ fontSize: 18 }} /> },
                { key: `${Urls.Configuraciones.Base}/${Urls.Configuraciones.Ocupaciones}`, label: 'Ocupaciones', icon: <IconConfig style={{ fontSize: 18 }} /> },
                { key: `${Urls.Prestamos.Base}/${Urls.Prestamos.Estados}`, label: 'Estados de Prestamos', icon: <IconConfig style={{ fontSize: 18 }} /> },
                { key: `${Urls.Prestamos.Base}/${Urls.Configuraciones.Sexos}`, label: 'Sexos', icon: <IconConfig style={{ fontSize: 18 }} /> },
            ],
        },
        {
            key: `${uuidv4()}`,
